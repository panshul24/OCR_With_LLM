        ...
        <body>
                  ...
                  <div id=\"dropzone\" class=\"dropzone\">
                    <div>
                      ...
                      <div style=\"margin-top:8px\">
                        <label class=\"btn\" for=\"filesInput\">Upload Files</label>
          ...
          <script>
            ...
            function summaryLine(item){
              var c = item.categories || {}; var fields = [];
              ...
              var cat = c.document_type || 'unknown';
              return 'Category: ' + cat + '\\n' + (fields.length ? ('Fields: ' + fields.join(', ')) : 'Fields: -');
            }
            ...
            async function processFiles(){
              ...
              try {
                ...
                summaryEl.textContent = Array.isArray(data.items) ? data.items.map(summaryLine).join('\\n\\n') : summaryLine(data);
